...
import { AlertCircle, ChevronLeft, CreditCard, Edit, FileText, Info, Plus, Save, Trash, Trash2, X } from 'lucide-react'
import { Link, useLocation, useNavigate } from "react-router-dom"
import { useCallback } from 'react'

export default function DetallesPago({pagos, onUpdatePagos, onDeletePago, isLoading}) {
                                            ...
                                            <AlertDialogContent className="bg-gray-800 text-white">
                                                ...
                                                <AlertDialogFooter>
                                                    ...
                                                    <Link to={'/pagos'}>
                                                        <AlertDialogAction
                                                            onClick={() => {
                                                                handleDelete(editedPayment.IdPagoOK)   
                                                            }}
