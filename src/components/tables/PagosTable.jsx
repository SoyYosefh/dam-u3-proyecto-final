...
import { ArrowDown, ArrowUp, ArrowUpDown, ChevronDown, ChevronLeft, ChevronRight, Eye, Trash2, Edit } from 'lucide-react'
...
export default function PaymentTable({ dataPagos = [], onDeletePago }) {
  ...
  if (loadingTable) {
    return (
      <div className="flex items-center justify-center gap-4 p-4 bg-gray-800 rounded-md text-white">
      ...
      <div className="flex items-center justify-between space-x-2 py-4">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="bg-
gray-800 text-white hover:bg-gray-700 disabled:opacity-50"
          >
